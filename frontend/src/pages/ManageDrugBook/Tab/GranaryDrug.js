    ...
    const saveDrugBook = () => {
        ...
        if (_drugbook.drugname) {
            if (drugbook._id) {
                ...
                console.log('drugbook', _drugbook);
                    ...
                    <div className="formgrid grid">
                        ...
                        <div className="field col">
                            ...
                            <InputText
                                ...
                                // className={cx({ 'p-invalid': submitted && !product.name }, 'hung')}
                            />
                            {/* {submitted && !drugbook.unitprice && (
                                <small className="p-error">Unit/Price is required.</small>
                            )} */}
                        </div>
                    </div>
                    <div className="field">
